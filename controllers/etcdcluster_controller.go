...
// +kubebuilder:rbac:groups=apps,resources=statefulsets,verbs=delete;update;patch
// +kubebuilder:rbac:groups=core,resources=services,verbs=delete;update;patch
